...
export default function LabelEditingProvider(
    ...
    eventBus.on('create.end', 500, function (e) {
        ...
        const doNotEditLabel = e.context ? e.context.doNotEditLabel : false;
...
LabelEditingProvider.prototype.activate = function (element) {
    ...
    const editingBBox = this.getEditingBBox(element);
...
LabelEditingProvider.prototype.getEditingBBox = function (element) {
    ...
    const defaultFontSize = defaultStyle.fontSize * zoom,
...
LabelEditingProvider.prototype.update = function (
    ...
    this._modeling.updateLabel(element, newLabel, newBounds, hints);
};
