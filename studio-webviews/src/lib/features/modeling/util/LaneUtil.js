import { resizeTRBL, substractTRBL } from 'diagram-js/lib/features/resize/ResizeUtil';
...
export function computeLanesResize(shape, newBounds) {
	...
	var initialShapes = is(rootElement, 'flow:State') ? [] : [rootElement];
