...
import { assign, filter, find } from 'min-dash';

export default function DropOnFlowBehavior(eventBus, flowRules, modeling) {
	...
	function insertShape(shape, targetFlow, position) {
		...
		if (flowRules.canConnect(source, shape, targetFlow)) {
		...
		if (flowRules.canConnect(shape, target, targetFlow)) {
	...
	this.preExecute('elements.move', function (context) {
		...
		var connection = find(newParent.children, function (element) {
			var canInsert = flowRules.canInsert(shapes, element);
	...
	this.preExecute('shape.create', function (context) {
		...
		if (flowRules.canInsert(shape, parent)) {
